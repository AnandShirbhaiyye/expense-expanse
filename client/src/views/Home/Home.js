            ...
            <div className="card shadow-lg p-3">
              <div className="card-body">
                ...
                <p className="card-text">
                  ...
                  giving you a comprehensive snapshot of your financial health.
                </p>
              </div>
            </div>
          </div>
          <div className="col-md-4 mt-5">
            <div className="card shadow-lg p-3">
              <div className="card-body">
                ...
                <p className="card-text">
                  Take control of your financial journey by tracking your income
                  and expenses effortlessly. Expanse Tracker adapts to your
                  needs.
                </p>
              </div>
            </div>
